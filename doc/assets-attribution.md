The following is a list of assets used in the diamond source and their proper attribution.
...
* License: MIT
* Site: [https://diamondtalk.org/index.php?topic=15276.0](https://diamondtalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original diamond logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/diamond.icns, src/qt/res/src/diamond.svg,
	src/qt/res/src/diamond.ico, src/qt/res/src/diamond.png,
	src/qt/res/src/diamond_testnet.png, docs/diamond_logo_doxygen.png,
