Download URL: https://sourceforge.net/projects/diamond/files/Diamond/diamond-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 TGD fee schedule (users still pay 0.01 TGD per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #diamond00 - #diamond99
