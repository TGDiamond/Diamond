Diamond version 0.5.4 is now available for download at:
http://sourceforge.net/projects/diamond/files/Diamond/diamond-0.5.4/
...
http://gitorious.org/diamond/diamondd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Diamond-Qt notifications under Growl 1.3.
Increase required age of Diamond-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDiamond properly when installing Diamond-Qt over it. (Windows)
