...
*Setup instructions for a gitian build of Diamond using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Diamond
...
- [Building Diamond](#building-diamond)
...
- [LXC](https://linuxcontainers.org/), see also [Gitian host docker container](https://github.com/gdm85/tenku/tree/master/docker/gitian-diamond-host/README.md).
...
- Wait a dia while 'Select and install software' runs
...
git clone https://github.com/diamond/diamond
cd diamond
...
In [doc/release-process.md](release-process.md) in the diamond repository under 'Fetch and build inputs'.
...
To build Diamond (for Linux, OSX and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    From https://github.com/diamond/diamond
...
For example:
```bash
URL=https://github.com/laanwj/diamond.git
...
[diamond/gitian.sigs](https://github.com/diamond/gitian.sigs/) repository, or if that's not possible create a pull
