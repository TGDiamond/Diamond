...
unlocked to sign the Diamond-Qt.app bundle.
...
allowing somebody to distribute a Diamond-Qt.app or diamond-qt-setup.exe with a valid
...
that the diamond-qt.exe file inside the installer had not been tampered with.
