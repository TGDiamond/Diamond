...
###   This script attempts to download the signature file SHA256SUMS.asc from diacoin.org
...
WORKINGDIR="/tmp/diamond"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://diacoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://diacoin.org/bin/"
VERSIONPREFIX="diamond-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'diamond-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[diamond-]<version>-[rc[0-9]] (example: diamond-0.9.2-rc1)"
   echo "wget output:"
