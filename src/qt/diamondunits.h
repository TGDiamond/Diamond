...
#ifndef DIAMONDUNITS_H
#define DIAMONDUNITS_H
...
/** Diamond unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DiamondUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DiamondUnits(QObject *parent);

    /** Diamond units.
      @note Source: https://en.diamond.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TGD,
...
typedef DiamondUnits::Unit DiamondUnit;

#endif // DIAMONDUNITS_H
