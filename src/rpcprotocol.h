...
#ifndef _DIAMONDRPC_PROTOCOL_H_
#define _DIAMONDRPC_PROTOCOL_H_
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Diamond is not connected
