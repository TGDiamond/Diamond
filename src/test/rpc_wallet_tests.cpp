// Copyright (c) 2013-2014 The Diamond Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CDiamondAddress demoAddress = CDiamondAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CDiamondAddress setaccountDemoAddress = CDiamondAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CDiamondAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CDiamondAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
